package it.decoder.music.service
...
import it.decoder.innertube.requests.player
import it.decoder.music.Database
import it.decoder.music.MainActivity
import it.decoder.music.R
import it.decoder.music.enums.ExoPlayerDiskCacheMaxSize
import it.decoder.music.enums.ExoPlayerMinTimeForEvent
import it.decoder.music.models.Event
import it.decoder.music.models.QueuedMediaItem
import it.decoder.music.query
import it.decoder.music.utils.InvincibleService
import it.decoder.music.utils.RingBuffer
import it.decoder.music.utils.TimerJob
import it.decoder.music.utils.YouTubeRadio
import it.decoder.music.utils.activityPendingIntent
import it.decoder.music.utils.broadCastPendingIntent
import it.decoder.music.utils.closebackgroundPlayerKey
import it.decoder.music.utils.exoPlayerDiskCacheMaxSizeKey
import it.decoder.music.utils.exoPlayerMinTimeForEventKey
import it.decoder.music.utils.findNextMediaItemById
...
import it.decoder.music.utils.isInvincibilityEnabledKey
import it.decoder.music.utils.isShowingThumbnailInLockscreenKey
import it.decoder.music.utils.mediaItems
...
import it.decoder.music.utils.timer
import it.decoder.music.utils.trackLoopEnabledKey
...
class PlayerService : InvincibleService(), Player.Listener, PlaybackStatsListener.Callback,
    ...
    override fun onCreate() {
        ...
        if (exoPlayerAlternateCacheLocation=="") {
           directory = cacheDir.resolve("music_cache").also { directory ->
                ...
                directory = path?.resolve("music_cache").also { directory ->
...
*/
                            ...
                            when (val status = body.playabilityStatus?.status) {
                                "OK" -> body.streamingData?.highestQualityFormat?.let { format ->
                                    ...
                                    query {
                                        ...
                                        Database.insert(
                                            it.decoder.music.models.Format(
                                                songId = videoId,
                                                itag = format.itag,
    ...
    private value class Action(val value: String) {
        ...
        companion object {
            val pause = Action("it.decoder.music.pause")
            val play = Action("it.decoder.music.play")
            val next = Action("it.decoder.music.next")
            val previous = Action("it.decoder.music.previous")
        }
    }
